...
public class Consultar {
  	...
  	public String consultarQuantGolsCopa(int ano){
  		...
  		Jogo jogo = null;
  			...
  			resultado = new String ("Total de gols:" + qntGols + "Media de gols por partida:" + media );
  	...
  	public List<Jogador> consultarJogadorMaisGolsPartida(Jogo jogo){
  		...
  		for(int i = 0; i < jogo.getGols().size(); i++){
  			...
  			for(int j = 0; j < jogo.getGols().size(); j++){
  				...
  				//A cada vez que o autor do gol da lista eh o jogador em questao, o contador dele eh incrementado
